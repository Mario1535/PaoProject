...
static constexpr auto qt_meta_stringdata_ZN9ContainerE = QtMocHelpers::stringData(
    "Container"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9ContainerE[] = {
...
Q_CONSTINIT const QMetaObject Container::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9ContainerE.offsetsAndSizes,
    qt_meta_data_ZN9ContainerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9ContainerE_t,
        // Q_OBJECT / Q_GADGET
...
void *Container::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9ContainerE.stringdata0))
